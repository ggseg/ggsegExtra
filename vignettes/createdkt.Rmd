...
We will here show the fully automated way we have created the [ggsegDKT](https://lcbc-uio.github.io/ggsegDKT/) atlas data.
...
### The 3d atlas
Once an annotation file is made, you can proceed to creating the 3d-mesg atlas.
...
Onve we are satisfied with the region names, we should also alter the atlas name in the data, to something a little more pleasing.
...
ggseg3d(atlas = dkt_3d, hemisphere = "right", surface = "white")
```
