...
ggseg.extra does two things: it helps you find and install brain atlases that work with ggseg and ggseg3d, and it provides the tools to create your own from neuroimaging data.

## Finding and installing atlases

Atlases live in their own packages, distributed through the [ggsegverse r-universe](https://ggsegverse.r-universe.dev).
...
ggseg.extra provides four functions to create brain atlases from different neuroimaging inputs:

| Function | Input | Use case |
|----------|-------|----------|
| `create_cortical_from_annotation()` | FreeSurfer annotation files | Cortical parcellations (DK, DKT, Yeo networks) |
...
All four produce a `ggseg_atlas` object that works with both ggseg and ggseg3d.
