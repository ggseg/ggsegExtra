...
```{r, eval = FALSE}
dt <- ggseg3d_2_ggseg(ggseg3d_atlas = dk_3d,
                steps = 1:5, 
                output_dir = tempdir(),
                cleanup = FALSE,
                verbose = TRUE)
...
This column should ideally have human readable names, short and have space rather than delimiters. 
This is to enable nicer labelling when plotting.
Once this is one, make is a ggseg-atlas, and try plotting it with ggseg.

```{r, eval=FALSE}
dt <- as_ggseg_atlas(dt)
```
