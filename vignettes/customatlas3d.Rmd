...
Because the DKT atlas is the same as the DK atlas, minus a couple of regions, we here joing in the label and region column from the `ggseg::dk` data, to re-populate the `region` column with nicer names.
