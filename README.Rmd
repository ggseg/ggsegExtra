...
for (i in 1:nrow(atlases)) {
  ...
  # find doi
  readmeurl <- sprintf("https://raw.githubusercontent.com/ggseg/%s/main/README.md", atl)
  if(httr::http_error(readmeurl))
    readmeurl <- sprintf("https://raw.githubusercontent.com/ggseg/%s/master/README.md", atl)
