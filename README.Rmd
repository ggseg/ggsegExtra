...
for (i in 1:nrow(atlases)) {
  cat(sprintf('### [%s](%s)', 
      ...
      sprintf('<img src="%s/raw/HEAD/man/figures/logo.png" align="right" alt="%s logo" width="120"/>',
              atlases[i, "RemoteUrl"], atlases[i, "Package"]),
      sprintf('\n[![R-CMD-check](https://github.com/ggseg/%s/workflows/R-CMD-check/badge.svg)](https://github.com/ggseg/%s/actions)', 
              atlases[i, "Package"], atlases[i, "Package"]),
