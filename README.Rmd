...
atlases <- atlases[
  grep("ggseg$|ggsegExtra$|ggseg3d$", atlases$Package, invert = TRUE),
]
```
...
<!-- badges: start -->
[![Coverage Status](https://raw.githubusercontent.com/ggseg/ggsegExtra/coverage/badges/coverage.svg)](https://github.com/ggseg/ggsegExtra/actions/workflows/test-coverage.yaml)
...
We recommend installing this package from its [r-universe](https://ggseg.r-universe.dev/#builds) build:
...
for (i in 1:nrow(atlases)) {
  ...
  # find doi
  readmeurl <- sprintf(
    "https://raw.githubusercontent.com/ggseg/%s/main/README.Rmd",
    atl
  )
  if (httr::http_error(readmeurl)) {
    readmeurl <- sprintf(
      "https://raw.githubusercontent.com/ggseg/%s/master/README.Rmd",
      atl
    )
  }
