...
This package provides pipelines for creating brain atlas data sets compatible with the [ggseg](https://ggsegverse.github.io/ggseg/) and [ggseg3d](https://ggsegverse.github.io/ggseg3d/) plotting packages in R.

## Installing

Install the development version from [r-universe](https://ggsegverse.r-universe.dev/#builds):
...
Tutorials are available in the `Articles` of the [package documentation page](https://ggsegverse.github.io/ggseg.extra/).
The cortical pipeline projects inflated mesh triangles directly to 2D polygons — atlas creation takes seconds and needs only FreeSurfer to read annotation files (no rendering, ImageMagick, or Chrome).
Subcortical and tract pipelines are also available.
